      ...
      <section className="section section-dark">
        <div className="container">
          ...
          <h2 style={{ marginBottom: "2.5rem" }}>
            Learn from Educators Who&apos;ve<br />Shaped the Industry.
          </h2>

          <div className="facultyCard">
            <div className="facultyAvatar">👩‍🏫</div>
            <div className="facultyBody">
              <div className="facultyName">Shraddha Gadit</div>
              <div className="facultyRole">
                Education Lead &amp; Senior Faculty, KPF
              </div>
              <p className="facultyBio">
                With over 17 years of experience in fitness education, nutrition
                science, and academic leadership, Shraddha Gadit is the driving
                force behind KPF&apos;s curriculum and learning philosophy.
              </p>
              <p className="facultyBio">
                A Gold Medalist with a postgraduate degree in Food Science and
                Nutrition, Shraddha has served as a Department Head, Nutrition
                Lecturer at leading institutions, and education lead for one of
                India&apos;s most recognised fitness brands.
              </p>
              <p className="facultyBio" style={{ marginBottom: "2rem" }}>
                Her approach is defined by scientific accuracy, practical
                simplicity, and a deep commitment to building professionals —
                not just graduates.
              </p>
